...
def predict_ability_capture(img) -> bool:
    """
        Функция для определения возможности захватить груз.

        Входные данные: изображение (bgr), прочитано cv2.imread
        Выходные данные: True или False, в завимости от того, можно поместить объект в захват или нет
